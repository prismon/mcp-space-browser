...
.
├── cmd/
│   ├── mcp-space-browser/    # CLI application (main.go)
...
4. **HTTP Server**: API endpoints for indexing and tree data
5. **MCP Server**: 17 tools for disk space analysis via Model Context Protocol
